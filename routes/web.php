...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    */
    ...
    Route::prefix('gastos')->name('gastos.')->group(function () {
        ...
        Route::get('{id}/comprobante', [FactGastoGeneralController::class, 'showComprobante'])->name('comprobante');
        Route::get('{id}/comprobante/download', [FactGastoGeneralController::class, 'downloadComprobante'])->name('comprobante.download');
    });
