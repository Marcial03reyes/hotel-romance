...
@section('title', 'Editar Comprobante SUNAT - Hotel Romance')
...
<head>
    ...
    <style>
        ...
        /* Badge para ID del comprobante */
        .comprobante-id-badge {
...
<body class="text-gray-800 font-inter bg-gray-50">
    ...
    <main class="min-h-screen py-6 px-4" style="background: linear-gradient(135deg, var(--sidebar-bg) 0%, #ffffff 100%);">
        <div class="max-w-4xl mx-auto mt-1">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold">
                                Editar Comprobante SUNAT 
                                <span class="comprobante-id-badge ml-2">#{{ $comprobante->id_sunat }}</span>
                            </h1>
                            <p class="text-blue-100 mt-1">Modifica los detalles del comprobante seleccionado</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-container">
                ...
                <form action="{{ route('sunat.update', $comprobante->id_sunat) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="tipo_comprobante" id="tipo_comprobante" 
                                ...
                                <option value="NINGUNO" {{ (old('tipo_comprobante') ?? $comprobante->tipo_comprobante) == 'NINGUNO' ? 'selected' : '' }}>NINGUNO</option>
                                <option value="BOLETA" {{ (old('tipo_comprobante') ?? $comprobante->tipo_comprobante) == 'BOLETA' ? 'selected' : '' }}>BOLETA</option>
                                <option value="FACTURA" {{ (old('tipo_comprobante') ?? $comprobante->tipo_comprobante) == 'FACTURA' ? 'selected' : '' }}>FACTURA</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="codigo_comprobante" id="codigo_comprobante" 
                                   ...
                                   value="{{ old('codigo_comprobante') ?? $comprobante->codigo_comprobante }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_comprobante" id="fecha_comprobante" 
                                   ...
                                   value="{{ old('fecha_comprobante') ?? $comprobante->fecha_comprobante->format('Y-m-d') }}" required>
                            ...
                            <div class="current-file-alert">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('sunat.archivo', $comprobante->id_sunat) }}" target="_blank" class="ml-2">
                                            <i class='bx bx-link-external mr-1'></i>Ver archivo actual
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-end">
                        ...
                        <button type="submit" class="btn-romance">
                            <i class='bx bx-save mr-2'></i>Actualizar Comprobante
                        </button>
                    </div>
                </form>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-gray-600">
                            ...
                            <ul class="space-y-1 text-xs">
                                ...
                                <li>• La fecha del comprobante debe corresponder al documento fiscal real</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const badge = document.querySelector('.comprobante-id-badge');
            if (badge) {
