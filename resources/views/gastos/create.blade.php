...
@section('title', 'Agregar Gasto - Hotel Romance')
            ...
            <div class="page-header">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 mt-1">Registra un nuevo gasto del hotel con todos los detalles necesarios</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('gastos.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="id_tipo_gasto" id="id_tipo_gasto" 
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('id_tipo_gasto') border-red-500 @enderror" required>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-end">
                        ...
                        <button type="submit" class="btn-romance">
                            <i class='bx bx-save mr-2'></i>Guardar Gasto
                        </button>
                    </div>
                </form>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-gray-600">
                            ...
                            <ul class="space-y-1 text-xs">
                                ...
                                <li>• Puedes adjuntar una imagen o PDF del comprobante</li>
                                <li>• Los datos se pueden editar posteriormente desde la lista de gastos</li>
                            </ul>
                        </div>
                    </div>
                </div>
