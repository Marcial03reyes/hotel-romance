...
@section('title', 'Editar Gasto Variable')
    ...
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-3xl font-bold flex items-center">
                <i class='bx bx-edit mr-3 text-4xl'></i>
                Editar Gasto Variable
            </h1>
            <p class="opacity-90 mt-1">Modifica los datos del gasto variable</p>
        </div>
    </div>
</div>
...
<div class="form-container max-w-2xl mx-auto">
                ...
                <div class="flex space-x-4">
                    <label class="flex-1 cursor-pointer">
                        <input type="radio" name="turno" value="0" class="sr-only turno-radio" 
                            {{ (old('turno', $gasto->turno) == '0') ? 'checked' : '' }} required>
                    ...
                    <label class="flex-1 cursor-pointer">
                        <input type="radio" name="turno" value="1" class="sr-only turno-radio" 
                            {{ (old('turno', $gasto->turno) == '1') ? 'checked' : '' }} required>
    ...
    <div class="mt-6 p-4 rounded-lg" style="background: rgba(136, 166, 211, 0.1); border-left: 4px solid var(--primary-color);">
        ...
        <ul class="text-xs text-gray-600 space-y-1">
            <li>• Puedes cambiar el código del comprobante en cualquier momento</li>
            <li>• El código de comprobante es opcional pero recomendado</li>
            <li>• El código de boleta es opcional pero recomendado</li>
