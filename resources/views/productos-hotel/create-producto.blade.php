...
@section('title', 'Crear Nuevo Producto de Hotel')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Crear Nuevo Producto de Hotel</h1>
                    <p class="text-gray-600 mt-1">Agrega un nuevo producto interno del hotel (limpieza, mantenimiento, etc.)</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <form action="{{ route('productos-hotel.store-producto') }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm text-blue-700 space-y-1">
                                ...
                                <p>• Te ayudará a saber cuándo es momento de recomprar cada producto</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-md p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h4 class="text-sm font-medium text-yellow-800 mb-2">Ejemplos de productos de hotel</h4>
                    <div class="text-sm text-yellow-700 grid grid-cols-2 md:grid-cols-3 gap-2">
                        <span class="bg-yellow-100 px-2 py-1 rounded text-xs">Lejía</span>
                        <span class="bg-yellow-100 px-2 py-1 rounded text-xs">Detergente</span>
                        <span class="bg-yellow-100 px-2 py-1 rounded text-xs">Papel higiénico</span>
                        <span class="bg-yellow-100 px-2 py-1 rounded text-xs">Toallas</span>
                        <span class="bg-yellow-100 px-2 py-1 rounded text-xs">Jabón líquido</span>
                        <span class="bg-yellow-100 px-2 py-1 rounded text-xs">Desinfectante</span>
                    </div>
                </div>
            </div>
        </div>
