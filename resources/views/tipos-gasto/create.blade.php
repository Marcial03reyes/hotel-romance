    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Crear Tipo de Gasto</h1>
                    <p class="text-gray-600 mt-1">Agrega una nueva categoría de gasto para el hotel</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('tipos-gasto.store') }}" method="POST">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h4 class="text-sm font-medium text-blue-800 mb-2">Ejemplos de tipos de gasto</h4>
        ...
        <div class="mt-6 bg-gray-50 border border-gray-200 rounded-md p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h4 class="text-sm font-medium text-gray-800 mb-2">¿Para qué sirven los tipos de gasto?</h4>
                    <div class="text-sm text-gray-600 space-y-1">
                        <p>Los tipos de gasto te permiten:</p>
                        <p>• Organizar y categorizar todos los gastos del hotel</p>
                        <p>• Generar reportes por categoría</p>
                        <p>• Analizar en qué áreas se gasta más dinero</p>
                        <p>• Controlar mejor el presupuesto por área</p>
                    </div>
                </div>
            </div>
        </div>
