    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Editar Tipo de Gasto</h1>
                    <p class="text-gray-600 mt-1">Modifica el nombre del tipo: <span class="font-medium">{{ $tipo->nombre }}</span></p>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('tipos-gasto.index') }}" 
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('tipos-gasto.update', $tipo->id_tipo_gasto) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ej: Servicios básicos, Limpieza, Mantenimiento..."
                               maxlength="100"
                               required>
                    ...
                    @if($tipo->gastos->count() > 0)
                        <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h4 class="text-sm font-medium text-yellow-800 mb-2">Tipo de gasto en uso</h4>
                                    <div class="text-sm text-yellow-700">
                                        <p>Este tipo de gasto está siendo usado en <strong>{{ $tipo->gastos->count() }} gastos registrados</strong>.</p>
                                        <p class="mt-1">Los cambios se aplicarán a todos los gastos que usen esta categoría.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h4 class="text-sm font-medium text-blue-800 mb-2">Consejos para nombrar tipos de gasto</h4>
                                <div class="text-sm text-blue-700 space-y-1">
                                    <p>• Usa nombres descriptivos y específicos</p>
                                    <p>• Evita nombres muy largos o complicados</p>
                                    <p>• Piensa en cómo los verás en los reportes</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-6 bg-gray-50 border border-gray-200 rounded-md p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h4 class="text-sm font-medium text-gray-800 mb-2">Información del tipo de gasto</h4>
                    <div class="text-sm text-gray-600 space-y-1">
                        <p><strong>ID:</strong> {{ $tipo->id_tipo_gasto }}</p>
                        <p><strong>Nombre actual:</strong> {{ $tipo->nombre }}</p>
                        <p><strong>Gastos registrados:</strong> {{ $tipo->gastos->count() }}</p>
                        <p class="text-xs text-gray-500 mt-2">
                            Solo puedes cambiar el nombre del tipo. Para eliminar este tipo, regresa a la lista principal.
                        </p>
                    </div>
                </div>
            </div>
